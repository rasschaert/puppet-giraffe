  ...
  $dashboards = [
    {
      name        =>'Demo',
      refresh     => 5000,
      description => '#Giraffe : A [Graphite](http://graphite.wikidot.com) \
Dashboard with a long neck <img class=\'pull-right\' src=\'img/giraffe.png\' />\
\n\n<br/>\n<a class=\'btn btn-large btn-warning\' \
href=\'https://github.com/kenhub/giraffe\'><i class=\'icon-github icon-large\'>\
</i> View project on github</a>\n\n##More?\n\nCheck out the different \
dashboards for more information about riding giraffes.',
      metrics     =>
      [
        {
          alias             => 'signups',
        ...
        },
        {
          ...
          targets       => ['sumSeries(enter.your.graphite.metrics.here)',
        ...
        },
        {
          ...
          target          =>'sumSeries(enter.your.graphite.metrics.here)',
          target          => 'function() { return \'summarize(\
events.registration.success,\'\' + entire_period() + \'min)\' }',
          renderer        =>'bar',
